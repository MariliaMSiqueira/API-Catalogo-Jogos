...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public Task<string> Get()
        {
            ...
            stringBuilder.AppendLine($"Singleton 1: {_exemploSingleton1.Id}"); // Quando a aplicação sobe em memória ele gera uma instância do recurso. Essa instância ficará até que se encerre o app. Assemelha-se a uma classe static
            stringBuilder.AppendLine($"Singleton 2: {_exemploSingleton2.Id}");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine($"Scoped 1: {_exemploScoped1.Id}"); // Somente uma instância que perdura por toda a requisição. 
            stringBuilder.AppendLine($"Scoped 2: {_exemploScoped2.Id}");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine($"Transient 1: {_exemploTransient1.Id}"); //Cada injeção/get/request haverá uma nova instância 
    ...
    {
        public Guid Id { get; } //Não pode ser alterado
    }
